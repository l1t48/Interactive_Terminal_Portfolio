export const softwareProjects = [
    ...
    {
        title: "Business System (C#)",
        overview: "A business system for a physical store that sells media products (e.g., books, CDs, and games). Supports both cash register operations and inventory management with CSV-based product storage.",
        url: "https://github.com/l1t48/CS/tree/main/Store-app",
        liveUrl: null,
        tags: ["Windows Forms", "C#", "GUI", "Modularity", "OOP", "Docker"],
        is_public: true,
    },
    {
        title: "Text Editor (C#)",
        overview: "A Windows Forms text editor similar to Notepad. Supports creating, opening, editing, and saving text files with Save and Save As functionality, plus unsaved-change handling and error reporting.",
        url: "https://github.com/l1t48/CS/tree/main/Texteditor",
        liveUrl: null,
        tags: ["Windows Forms", "C#", "GUI", "Modularity", "OOP", "Docker"],
        is_public: true,
    },
